...
def main() -> None:
    ...
    ax.plot(vr_values, mn_abrupt_plot, label=r"$M_n$, abrupt")
    ax.plot(vr_values, mp_abrupt_plot, label=r"$M_p$, abrupt")
    ax.plot(vr_values, mn_graded_plot, "--", label=r"$M_n$, graded")
    ax.plot(vr_values, mp_graded_plot, "--", label=r"$M_p$, graded")
    ...
    ax.semilogy(vr_values, mn_abrupt_semilog, label=r"$M_n$, abrupt")
    ax.semilogy(vr_values, mp_abrupt_semilog, label=r"$M_p$, abrupt")
    ax.semilogy(vr_values, mn_graded_semilog, "--", label=r"$M_n$, graded")
    ax.semilogy(vr_values, mp_graded_semilog, "--", label=r"$M_p$, graded")
    ax.set_xlabel(r"$V_R$ / V")
    ax.set_ylabel("multiplication factor")
